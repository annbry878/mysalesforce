...
def export_distributors(request):
    ...
    writer.writerow(['distributorName', 'email', 'phone', 'phone2', 'contactPerson', 'contactPerson2', 'addressLine1', 'addressLine2',
                     'city', 'postalCode', 'country', 'website', 'additionalInfo'])
