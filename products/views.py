...
def export_products(request):
    ...
    writer.writerow(['productCode', 'serialNo', 'category', 'description', 'distributor', 'pricePerUnit', 'srp'])

    products = Product.objects.all().values_list('productCode', 'serialNo', 'category', 'description', 'distributor', 'pricePerUnit', 'srp')
...
def export_products_batch(request, id):
    ...
    for myId in listId:
        myId = int(myId)
        products = Product.objects.values_list('productCode', 'serialNo', 'category', 'description', 'distributor', 'pricePerUnit', 'srp',).get(pk=myId)
